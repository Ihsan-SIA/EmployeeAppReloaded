    ...
    public class DepartmentController : BaseController
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Detail(DepartmentViewModel departmentViewModel)
        {
            var departments = await _departmentService.GetDepartmentByIdAsync(departmentViewModel.Id);
            if (departments == null)
            {
                return View(departments);
            }
